package com.evento.publisher;

import com.evento.avro.Email;
import com.evento.handler.EmailPublisherHandler;
...
@SpringBootTest
@DirtiesContext
public class EmailPublisherHandlerTest {

    private static final Logger LOGGER =
            LoggerFactory.getLogger(EmailPublisherHandlerTest.class);
    @ClassRule
    public static KafkaEmbedded embeddedKafka = new KafkaEmbedded(1, true, "email.service.topic");
    private static final String SENDER_TOPIC = "email.service.topic";
    @Autowired
    private EmailPublisherHandler publisher;
