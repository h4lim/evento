package com.evento.subscriber;

import com.evento.avro.Email;
import com.evento.handler.EmailSubscriberHandler;
...
@SpringBootTest
@DirtiesContext
public class EmailSubscriberHandlerTest {

    private static final Logger LOGGER =
            LoggerFactory.getLogger(EmailSubscriberHandlerTest.class);
    @ClassRule
    public static KafkaEmbedded embeddedKafka = new KafkaEmbedded(1, true, "email.service.topic");
    private static final String RECEIVER_TOPIC = "email.service.topic";
    @Autowired
    private EmailSubscriberHandler subscriber;
